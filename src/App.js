  ...
  render(){
    ...
    return(
      ...
      <div className='actions-container'>
        ...
        {/*
        <div className='scripts-container_header'>
          <h4>Scripts:</h4>

          <button>
            <Icon name='toggle-on' size="18" fill='#74B974' style={{margin:'10px'}}/>
          </button>

        </div>
        <div style={{backgroundColor:'#D5D5D5', width:'100%', height:'1px'}}></div>

        <div className="scripts-units">
          Smart punctuation
        </div>

        <div className='statistics-container_header'>
          <h4>Statistics:</h4>
        </div>

        <div className="statistics-units">
          Words:0
        </div>*/}
        ...
        <div className="find-textarea_wrapper">
          ...
          />
            ...
            <button
              className='action-unit_delete-button'
            >
              <Icon name='toggle-on' size="12" fill='#74B974'/>
            </button>
            <button
              className='action-unit_delete-button'
            >
              <Icon name='sliders-h' size="12" fill='#ADADAD'/>
            </button>
            */}
...
class Icons extends React.Component {
  render(){
    return (
      ...
      {/*
        <Icon name='twitter-square' size="18" fill='#fff' style={{margin:'15px 10px 0 10px'}}/><br />
        <Icon name='twitter-square' size="18" fill='#fff' style={{margin:'10px 10px 0 10px'}}/><br />
        <Icon name='twitter-square' size="18" fill='#fff' style={{margin:'10px 10px 0 10px'}}/><br />
        */}
      <header>
        <h1 className='logo'>text actions</h1>
      </header>
      {/*
      <div className='settings-icons'>
        <Icon name='question-circle' size="18" fill='#fff' style={{margin:'25px 10px 0 10px'}}/>
      </div>
      */}
      </div>
    )
